...
print('Motocicleta es instancia con relación a Vehiculo particular: ', isinstance(motocicleta, Particular))
print('Motocicleta es instancia con relación a Vehiculo de carga: ', isinstance(motocicleta, Carga))
